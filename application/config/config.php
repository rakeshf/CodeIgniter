...
|
*/
$config['base_url'] = 'http://chorbazaar.abc/';
...
|
*/
$config['encryption_key'] = 'cw0TlxUj2VQYFE7UGE2C';
...
$config['csrf_token_name'] = 'csrf_chortoekn_name';
$config['csrf_cookie_name'] = 'csrf_chorcookie_name';
